      ...
      <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center flex-wrap">
          ...
          <div class="heading-elements d-flex" style="gap:10px;">
            ...
            <?php endif; ?>
            <a href="<?= base_url('rekam_medis') ?>" class="btn btn-secondary font-weight-bold">
        ...
        <div class="card-content">
          <div class="card-body">
            ...
            <!-- Resep Obat -->
            <h5 class="text-info border-bottom pb-1 mb-2 mt-3"><i class="la la-clipboard"></i> Resep Obat</h5>
            <div class="row">
              <div class="col-12 mb-2">
                <div class="p-2 border border-warning rounded bg-light">
                  <?= !empty($rekam_medis['resep_obat']) 
                      ? nl2br(esc($rekam_medis['resep_obat'])) 
                      : '<em class="text-muted">Tidak ada resep obat tertulis.</em>' ?>
                </div>
              </div>
            </div>

<!DOCTYPE html>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
            <a href="#" class="d-block">Alisia Nazwa</a>
            </div>
        </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="col-12">
                ...
                <table class="table table-bordered text-hover table-striped mt-2 text-center">
                    <thead>
                        <tr>
                        <th width='3%'>No</th>
                        <th width='10%'>NIM</th>
                    ...
                    <?php $nom=1; foreach ($mahasiswa as $dt) { 
                        ...
                        <td class="text-center">
                            ...
                            data-target="#modal-hapusmahasiswa"
                            data-nim="<?= $dt['nim'] ?>">
    ...
    <!-- /.content-wrapper -->
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" name="kode_prodi" id="kode_prodi">
                                    ...
                                    <?php foreach($jurusan as $j) { ?>
                                        <option value = "<?= $j['kode_jur'].'-'.$j['kode_prodi'] ?>"><?= $j['jurusan'].' - '.$j['prodi'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
            ...
            <div class="modal fade" id="modal-editmahasiswa">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?= form_open('/updatedatamahasiswa') ?>
                        <div class="modal-body">
                            <div class="form-group row">
                                <label for="inputkode" class="col-sm-4 col-form-label">NIM</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nim" name="nim" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputkode" class="col-sm-4 col-form-label">Nama</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputkode" class="col-sm-4 col-form-label">Alamat</label>
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputkode" class="col-sm-4 col-form-label">Jenis Kelamin</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="jk">
                                        <option value="">..::Pilih::..</option>
                                        <option value="L">Laki-laki</option>
                            ...
                            <div class="form-group row">
                            <label class="col-sm-4 col-form-label">Prodi/Jurusan</label>
                                <div class="col-sm-8">
                                    <select class="form-control" name="kode_gabung" id="kode_gabung_edit">
                                        <option value="">..::Pilih::..</option>
                                        <?php foreach($jurusan as $j) { ?>
                                            <option value="<?= $j['kode_jur'].'-'.$j['kode_prodi'] ?>">
                                                <?= $j['jurusan'].' - '.$j['prodi'] ?>
                                            </option>
                                        <?php } ?>
                                    </select>
            ...
            <div class="modal fade" id="modal-hapusmahasiswa">
            <div class="modal-dialog">
                <div class="modal-content">
                <div class="modal-header">
                ...
                <?= form_open('/hapusdatamahasiswa') ?>
                <div class="modal-body">
                    <input type="hidden" class="form-control" id="nimx" name="nim" readonly>
    ...
    <script>
        ...
        var nilaiGabung = Jur + "-" + Prodi;
        $(".modal-body #kode_gabung_edit").val(nilaiGabung);
        });

        $(document).on("click", ".hapus-data", function(){
        var Nim = $(this).data('nim');x
        $(".modal-body #nimx").val(Nim);
        });
    </script>
    </html>